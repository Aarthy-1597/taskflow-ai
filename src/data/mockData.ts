...
export const tasks: Task[] = [
  {
    ...
    dueDate: '2026-02-20',
    labels: ['DevOps'],
    attachments: [{ id: 'att-t1-1', name: 'pipeline.yml', type: 'text/yaml', size: 1820, createdAt: '2026-02-10T12:00:00Z' }],
    subtasks: [],
    blockedBy: [],
    commentCount: 3,
    order: 0,
  },
  {
    ...
    labels: ['Design'],
    attachments: [
      { id: 'att-t2-1', name: 'wireframe-v1.fig', type: 'application/octet-stream', size: 841233, createdAt: '2026-02-20T09:00:00Z' },
      { id: 'att-t2-2', name: 'wireframe-v2.fig', type: 'application/octet-stream', size: 972110, createdAt: '2026-02-23T09:00:00Z' },
      { id: 'att-t2-3', name: 'wireframe-v3.fig', type: 'application/octet-stream', size: 1032210, createdAt: '2026-02-26T15:00:00Z' },
    ],
    subtasks: [
      { id: 'st-t2-1', title: 'Define dashboard sections', done: true },
      { id: 'st-t2-2', title: 'Create hi-fi wireframes', done: false },
    ],
    blockedBy: [],
    commentCount: 5,
    order: 0,
  },
  {
    ...
    description: 'Microsoft SSO integration with Azure AD',
    status: 'in_progress',
    priority: 'urgent',
    assignees: ['1'],
    projectId: 'p1',
    ...
    attachments: [],
    subtasks: [
      { id: 'st-t3-1', title: 'Register app in Azure AD', done: true },
      { id: 'st-t3-2', title: 'Implement callback handling', done: false },
    ],
    blockedBy: [],
    commentCount: 8,
    order: 0,
  },
  {
    ...
    description: 'Drag-and-drop Kanban board with @dnd-kit',
    status: 'in_progress',
    priority: 'high',
    assignees: ['3'],
    projectId: 'p1',
  ...
  },
  {
    ...
    dueDate: '2026-02-26',
    labels: ['Bug'],
    attachments: [{ id: 'att-t7-1', name: 'ios-safari-screencap.mov', type: 'video/quicktime', size: 1324012, createdAt: '2026-02-27T09:00:00Z' }],
    subtasks: [],
    blockedBy: [],
    commentCount: 4,
    order: 2,
  },
  {
    ...
    labels: ['Docs'],
    attachments: [
      { id: 'att-t8-1', name: 'openapi-draft.yaml', type: 'text/yaml', size: 20592, createdAt: '2026-02-18T11:00:00Z' },
      { id: 'att-t8-2', name: 'endpoints.xlsx', type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', size: 44592, createdAt: '2026-02-20T11:00:00Z' },
    ],
    subtasks: [],
    blockedBy: [],
    commentCount: 2,
  ...
  },
  {
    ...
    description: 'Add all button variants to design system',
    status: 'in_progress',
    priority: 'medium',
    assignees: ['4'],
    projectId: 'p4',
